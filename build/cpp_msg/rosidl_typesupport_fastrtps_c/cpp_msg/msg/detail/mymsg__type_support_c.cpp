...
#include "cpp_msg/msg/detail/mymsg__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_cpp_msg
...
using _Mymsg__ros_msg_type = cpp_msg__msg__Mymsg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_msg__msg__Mymsg;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cpp_msg__msg__Mymsg * ros_message = static_cast<const cpp_msg__msg__Mymsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cpp_msg__msg__Mymsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cpp_msg__msg__Mymsg * ros_message = static_cast<cpp_msg__msg__Mymsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cpp_msg__msg__Mymsg(cdr, ros_message);
}

static uint32_t _Mymsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_msg__msg__Mymsg(
...
static size_t _Mymsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cpp_msg__msg__Mymsg(
