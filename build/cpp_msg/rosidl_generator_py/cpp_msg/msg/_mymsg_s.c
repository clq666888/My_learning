...
bool cpp_msg__msg__mymsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cpp_msg.msg._mymsg.Mymsg", full_classname_dest, 24) == 0);
  }
  cpp_msg__msg__Mymsg * ros_message = _ros_message;
  {  // content
...
PyObject * cpp_msg__msg__mymsg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cpp_msg.msg._mymsg");
