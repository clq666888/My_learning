...
#include "cpp_msg/msg/detail/mymsg__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_msg
cdr_serialize(
  const cpp_msg::msg::Mymsg & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_msg::msg::Mymsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_msg::msg::Mymsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cpp_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<cpp_msg::msg::Mymsg>()
{
  return &cpp_msg::msg::typesupport_fastrtps_cpp::_Mymsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_msg, msg, Mymsg)() {
  return &cpp_msg::msg::typesupport_fastrtps_cpp::_Mymsg__handle;
}
